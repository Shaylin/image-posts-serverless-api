...
* Program.cs - entry point to the application that contains all the top level statements initializing the ASP.NET Core application.
...
Deploy application
```
    cd "image-posts-serverless-api/src/ServerlessAPI"
    sam deploy
```
